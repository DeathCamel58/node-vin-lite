...
const supportedWmis: string[] = ['YV1', 'YV2', 'YV3', 'YV4', '4V1', '4V2', '4V3', '4V4', '4V5', '4V6', '4VL', '4VM', '4VZ', 'MHA']
...
/**
 * Decodes Volvo's manufacturer specific VIN data
 *
 ...
 */
function decodeVin (vin: string): VolvoSpecific | null {
  const digit4 = vin[3]
  const digit5 = vin[4]
  const digit8 = vin[7]
  const gearbox = vin[8]
